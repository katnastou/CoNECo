...
wget https://zenodo.org/api/records/10623629/files/CoNECo_test_Jensenlab_tagger.tar.gz

tar -xzvf CoNECo_corpus.tar.gz
tar -xzvf CoNECo_test_Jensenlab_tagger.tar.gz
...
python ./evalso.py -d -v test-no_par_num CoNECo-tagger-standoff-test-norm --filtertypes OOS --overlap
